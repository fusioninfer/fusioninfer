...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoRAArtifactSpec) DeepCopyInto(out *LoRAArtifactSpec) {
	*out = *in
	out.BaseModelRef = in.BaseModelRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoRAArtifactSpec.
func (in *LoRAArtifactSpec) DeepCopy() *LoRAArtifactSpec {
	if in == nil {
		return nil
	}
	out := new(LoRAArtifactSpec)
	in.DeepCopyInto(out)
	return out
}
