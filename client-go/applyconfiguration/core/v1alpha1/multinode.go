...
// MultinodeApplyConfiguration constructs a declarative configuration of the Multinode type for use with
// apply.
func Multinode() *MultinodeApplyConfiguration {
	return &MultinodeApplyConfiguration{}
}
...
func (b *MultinodeApplyConfiguration) WithNodeCount(value int32) *MultinodeApplyConfiguration {
	b.NodeCount = &value
	return b
}
